...
export default function FeedbackPopup({ closePopup, feedback }) {

  return (
    <div id='feedbackPopupContainer' onClick={(e) => e.stopPropagation()} 
      className="w-[500px] bg-white p-[30px] rounded-[10px] shadow-standard flex flex-col gap-5 justify-center items-center">

      <p className="w-full text-[28px] text-left text-black1 font-extrabold">Here's some feedback!</p>
